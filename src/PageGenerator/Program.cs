...
namespace PageGenerator
{
    public class Program
    {
        ...
        {
            var diagnosticsLibInfo = _libraryManager.GetLibraryInformation("Microsoft.AspNet.Logging.Elm");
        ...
        private static void GenerateCodeFile(string cshtmlFilePath)
        {
            ...
            using (var fileStream = File.OpenText(cshtmlFilePath))
            {
                var code = engine.GenerateCode(
                    ...
                    rootNamespace: "Microsoft.AspNet.Logging.Elm.Views",
                ...
                while (startIndex < source.Length)
                {
                    ...
                    var replacement = File.ReadAllText(Path.Combine(basePath, includeFileName)).Replace("\"", "\\\"");
